...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCMaps",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCMaps-1.0.0-beta+20230328162416.xcframework.zip",
			checksum: "7b5040595b787fb9a5a3481e3fcc08ef0887bb75628c4c232af5a6243250be79"
		)
	]
)