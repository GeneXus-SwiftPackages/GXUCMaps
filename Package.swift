...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCMaps",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCMaps-1.0.0-beta.20230623154354.xcframework.zip",
			checksum: "342a184293dff539c160b53240ea11eeafba1573bc6b5bd775616aea7247a978"
		)
	]
)