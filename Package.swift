...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCMaps",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCMaps-1.0.0-beta+20230509173316.xcframework.zip",
			checksum: "2d27c6ad164604557845f23aff8abb10b0d9588404e09de275f5025363c95883"
		)
	]
)