...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCMaps",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCMaps-1.0.0-beta+20230502131235.xcframework.zip",
			checksum: "ce5cee8fa2af745098d44661d01765631078696706dc2553d1268fb6795950f0"
		)
	]
)