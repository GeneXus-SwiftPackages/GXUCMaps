...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCMaps",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCMaps-1.0.0-beta+20230323104412.xcframework.zip",
			checksum: "530948da55d313fc1f13062aabb47e8732f8fa11dd2a320125e2e13efa8f2dc3"
		)
	]
)