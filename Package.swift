...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCMaps",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCMaps-1.0.0-beta+20230509202229.xcframework.zip",
			checksum: "0da0ad2787aa452e1db3556685df9c62eb386eb55c4eacb3b876561d731fa682"
		)
	]
)