...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCMaps",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCMaps-1.0.0-beta+20230610052334.xcframework.zip",
			checksum: "623fe440e006b18e3eba11cfe3dea7cb7f25fd6d00248c4e715c9601fd8f1b4c"
		)
	]
)