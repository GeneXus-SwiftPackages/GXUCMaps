...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCMaps",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCMaps-1.0.0-beta.20230620165651.xcframework.zip",
			checksum: "c8bbf13e85cebb34398bde9ee57ee8a0c863fda8589f6dbbf7e514e602806d16"
		)
	]
)