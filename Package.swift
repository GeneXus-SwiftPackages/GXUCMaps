...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCMaps",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCMaps-1.0.0-beta.20230616185027.xcframework.zip",
			checksum: "474e0023e0d5ba9c6f2dca9ee58e5c0681a4b05cb3c8c50bd8716cc50a6f223a"
		)
	]
)