...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCMaps",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCMaps-1.0.0-beta+20230515023341.xcframework.zip",
			checksum: "732de2a8f7b44b5fca751c513f1bc235ba7197d6946471f414b78b412e36c9ba"
		)
	]
)