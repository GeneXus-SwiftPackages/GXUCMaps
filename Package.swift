...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCMaps",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCMaps-1.0.0-beta+20230519182256.xcframework.zip",
			checksum: "f34b03ed06a2fb41eddd1a7656a9120d114c984a05b94a559ca1b4c43d142b41"
		)
	]
)