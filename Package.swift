...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCMaps",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCMaps-1.0.0-beta+20230424185248.xcframework.zip",
			checksum: "652f13283abac69aba0b1d6d79cbfb32c9509b860b845af1a941c9fa57db6f2c"
		)
	]
)