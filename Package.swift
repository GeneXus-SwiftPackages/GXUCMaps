...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCMaps",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCMaps-1.0.0-beta+20230606172938.xcframework.zip",
			checksum: "312e12ea72b28225583a963b7281b9b6e0049622fbb21e5239aafc94b817b771"
		)
	]
)