...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCMaps",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCMaps-1.0.0-beta+20230330152753.xcframework.zip",
			checksum: "fd8f3b7a7f5ba3e945e3d02e0671b121e237c137afaef9f2ab17d5d68b8f4942"
		)
	]
)