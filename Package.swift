...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCMaps",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCMaps-1.0.0-beta+20230504210908.xcframework.zip",
			checksum: "f618ec10c2d1e31d1ca0a5635e59afa0e85f64180ded3b4ecd455595bc851318"
		)
	]
)