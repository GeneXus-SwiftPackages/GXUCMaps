...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCMaps",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCMaps-1.0.0-beta+20230519205149.xcframework.zip",
			checksum: "e30bd3dee55fb6f49600eebbb12258060980584eced4494b18837095e3d76c92"
		)
	]
)