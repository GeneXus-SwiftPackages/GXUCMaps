...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCMaps",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCMaps-1.0.0-beta+20230306155445.xcframework.zip",
			checksum: "50ae6d1bc1555b6fd1945ee1492f3281acd07f6b7555bd3fb2a50c79c32ab6fc"
		)
	]
)