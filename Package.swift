...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCMaps",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCMaps-1.0.0-beta.20230614190626.xcframework.zip",
			checksum: "3cb00f963309bd40c7f79a8d34ce89006e83cbf7a58cded8f3b4971856774bd2"
		)
	]
)