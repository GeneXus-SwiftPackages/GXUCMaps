...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCMaps",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCMaps-1.0.0-beta+20230427140435.xcframework.zip",
			checksum: "34505370b8b2e6c657fcfd8d82483620fd03af7cd6b1fe9e5753653b7adbf9a1"
		)
	]
)