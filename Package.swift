...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCMaps",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCMaps-1.0.0-beta.20230613192339.xcframework.zip",
			checksum: "771a1e4d6bcec1eefd09b6cbde989d081cc463664cc6d1b8eba04722e468d3d5"
		)
	]
)