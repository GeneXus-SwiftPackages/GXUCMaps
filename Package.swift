...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCMaps",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCMaps-1.0.0-beta+20230321182636.xcframework.zip",
			checksum: "1eb9368721019f1b8ac076ef43bcf044844f655add73653777e81b079e2d854d"
		)
	]
)